...
void sensor_task(void *argument) {
    ...
    for(;;) {
        ...
        /* 读取共享数据区（光照/LED状态，由LightTask写入） */
        app_data.light_adc = g_sensor_share.light_adc;
        app_data.blue_led = g_sensor_share.blue_led;
        app_data.green_led = g_sensor_share.green_led;
